...
ax = axes[2]
ax.semilogx(fd_hs, fd_errs, "o-", color=ORANGE, lw=2, ms=8,
            label="FD relative error  (%)")
ax.axhline(0.0, color=BLUE, lw=1.8, ls="--",
           label="HC  (machine precision, 4×10⁻¹⁶)")
...
ax.set_title("FD step-size sensitivity\n"
